...
const quickActions = [
  { label: "Agendar Cita", to: "/padres/agendar", icon: "M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z", color: "from-medi-500 to-medi-600", tutorialId: "agendar-cita-btn" },
  ...
  { label: "Historial", to: "/padres/historial", icon: "M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z", color: "from-medi-500 to-medi-600" },
  { label: "Mi Perfil", to: "/padres/perfil", icon: "M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z", color: "from-medi-500 to-medi-600" },
];
...
export const DashboardHome = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Banner de guía interactiva */}
      <div className="bg-gradient-to-r from-medi-50 to-emerald-50 border border-medi-200 rounded-2xl p-5 flex items-center gap-4">
        <div className="w-11 h-11 rounded-xl bg-medi-100 flex items-center justify-center shrink-0">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-medi-600">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z" />
          </svg>
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-extrabold text-gray-900">¿Ayuda para registrar una cita?</p>
          <p className="text-xs text-gray-500 font-medium mt-0.5">Te guiamos paso a paso por todo el proceso de forma interactiva.</p>
        </div>
        <button
          onClick={startTutorial}
          className="px-5 py-2.5 bg-medi-500 hover:bg-medi-400 active:scale-[0.97] text-white text-sm font-bold rounded-xl shadow-md transition-all shrink-0"
        >
          Iniciar Guía
        </button>
      </div>
