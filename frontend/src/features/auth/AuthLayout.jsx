...
export const AuthLayout = ({ children }) => {
  return (
    <div className="flex min-h-screen w-full font-sans bg-white text-gray-900 selection:bg-medi-900 selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-medi-50 flex-col px-12 xl:px-24 pt-12 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-xl mx-auto">
          <Link
            to="/"
            className="inline-flex flex-col font-black text-medi-400 tracking-tighter text-4xl lg:text-5xl hover:opacity-80 transition-opacity leading-none"
          >
            <span>medi</span>
            <span className="-mt-2.5">kids</span>
          </Link>
        </div>

        <div className="relative z-10 w-full max-w-xl mx-auto flex-1 flex items-center">
          <div>
